...
document.getElementById("data_atual").innerHTML = texto  +  day + "/" + month + "/" + year;
  ...
  <strong style="color:#fff;  text-transform: uppercase; font-family:Arial, Helvetica, sans-serif; font-size:16px; justify-content: center;">
    ...
    <iframe title="NISSIN" width="100%" height="700px" src=https://app.powerbi.com/view?r=eyJrIjoiNDJhNzBiOWEtNTZkZi00N2Q3LWE4M2ItYTFlZjU5NmMxZDFhIiwidCI6IjQ2ZTFjMjEwLTI1MjUtNGZlYy05ZTc3LTM4YWJlYzJjOWQ4NiJ9 frameborder="1" allowFullScreen="true" style="background-color:#000000;"></iframe>
</body>
