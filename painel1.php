...
include('protect.php');
if ($_SESSION['nivel'] != 2) die("Você não deveria estar aqui");
...
document.getElementById("data_atual").innerHTML = texto  +  day + "/" + month + "/" + year;
    ...
    <iframe title="KARCHER" width="100%" height="700px" src=https://app.powerbi.com/view?r=eyJrIjoiNWJhYjZiZjEtMDg0ZC00YjA0LTg5ZjctYzlhZTI3ZjJkMDkzIiwidCI6IjQ2ZTFjMjEwLTI1MjUtNGZlYy05ZTc3LTM4YWJlYzJjOWQ4NiJ9 frameborder="1" allowFullScreen="true" style="background-color:#000000;"></iframe>
</body>
