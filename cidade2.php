...
document.getElementById("data_atual").innerHTML = texto  +  day + "/" + month + "/" + year;
    ...
    <iframe title="AÇÃO DE INVERNO - BLACK PRINCESS - GRAMADO E CANELA" width="100%" height="700px" src=https://app.powerbi.com/view?r=eyJrIjoiYWI2MmViNjYtNWYzMy00MGQyLWFkMzMtMzNlZTQxNTk4MjUzIiwidCI6IjQ2ZTFjMjEwLTI1MjUtNGZlYy05ZTc3LTM4YWJlYzJjOWQ4NiJ9&pageName=ReportSection frameborder="1" allowFullScreen="true"></iframe></body>
