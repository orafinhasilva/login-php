...
document.getElementById("data_atual").innerHTML = texto  +  day + "/" + month + "/" + year;
    ...
    <iframe title="AÇÃO DE INVERNO - BLACK PRINCESS - SÃO ROQUE E REGIÃO" width="100%" height="700px" src=https://app.powerbi.com/view?r=eyJrIjoiYzY1MmZiY2QtZjFlNS00ZWE4LWJjMDMtY2E5ZDk1YjYzM2I3IiwidCI6IjQ2ZTFjMjEwLTI1MjUtNGZlYy05ZTc3LTM4YWJlYzJjOWQ4NiJ9&pageName=ReportSection frameborder="1" allowFullScreen="true"></iframe>
</html>